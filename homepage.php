...
<nav class="navbar navbar-expand-lg navbar-custom navbar-light">
  ...
  if (isset($_SESSION['email'])) {
    ...
    while ($row = mysqli_fetch_array($query)) {
      echo '<span class="navbar-text me-3" style="color: white;">' . $row['firstname'] . ' ' . $row['lastname'] . '</span>';
    }
    echo '<a href="logout.php" class="btn btn-danger" style="color: white; border-color: white;">Logout</a>'; // Logout button
  }
  ?>
</div>
  </div>
